...
Config.JerryCan = {
    ...
    price = 250,				-- Price to purchase it
...
Config.Electric = {
    ...
    chargeTypes = {
        fast = {
            price = 1.5,				-- Price per 1% recharged
            time = 1,					-- Time in seconds to recharge 0.5% of battery in the vehicle (lower values means faster refuel)
